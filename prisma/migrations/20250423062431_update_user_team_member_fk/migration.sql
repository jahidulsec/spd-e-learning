...
-- DropIndex
DROP INDEX `team_members_user_id_key` ON `team_members`;
...
-- AddForeignKey
ALTER TABLE `e_detailing_score` ADD CONSTRAINT `e_detailing_score_new_video_id_fkey` FOREIGN KEY (`video_id`) REFERENCES `e_detailing_video`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
