...
-- AlterTable
ALTER TABLE `quiz` ADD COLUMN `team_member_id` VARCHAR(100) NULL;

-- AddForeignKey
ALTER TABLE `quiz` ADD CONSTRAINT `quiz_team_member_id_fkey` FOREIGN KEY (`team_member_id`) REFERENCES `team_members`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
