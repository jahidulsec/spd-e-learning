/*
  ...
  - A unique constraint covering the columns `[answer_id]` on the table `result` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX `result_answer_id_key` ON `result`(`answer_id`);
