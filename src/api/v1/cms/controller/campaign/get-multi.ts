...
import { campaignQuerySchema } from "../../../../../schemas/campaign";
...
const get = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const validatedData = campaignQuerySchema.parse(req.query);

    let responseData: any;

    // response for super admin and director role
    if (
